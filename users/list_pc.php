...
if ($_POST['xls'] == 'Export xls') {
	header("Location: list_export.php?type=PC&value=".$_POST['PC']."&startdate1=".$_POST['startdate1']."&enddate1=".$_POST['enddate1']);
	exit();
}
...
if ($_POST["PC"] != "All") {$sql1 = " AND c_name='".$_POST["PC"]."'";} else {$sql1 = "";}
if ($_POST["startdate1"] && (strlen($_POST["startdate1"]) < 12)) {$startdate = rtrim($_POST["startdate1"])." 00:00:00";} else {$startdate = $_POST["startdate1"];}
if ($_POST["enddate1"] && (strlen($_POST["enddate1"]) < 12)) {$enddate = rtrim($_POST["enddate1"])." 23:59:59";} else {$enddate = $_POST["enddate1"];}
...
echo "</tr></tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td align='right'><b>Download &nbsp; <a href='".$protocol."://".$_SERVER['SERVER_NAME']."/". $_SESSION['dashboard'] ."/users/list_export.php?type=PC&value=".$_POST['PC']."&startdate=".$_POST['startdate']."&enddate=".$_POST['enddate']."' target='_blank'><img src='../lib/images/excel.ico' width='15' height='15' border='0'></a></td>";
