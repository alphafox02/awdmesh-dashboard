...
if ($_POST["startdate4"] && (strlen($_POST["startdate4"]) < 12)) {$startdate = rtrim($_POST["startdate4"])." 00:00:00";} else {$startdate = $_POST["startdate4"];}
if ($_POST["enddate4"] && (strlen($_POST["enddate4"]) < 12)) {$enddate = rtrim($_POST["enddate4"])." 23:59:59";} else {$enddate = $_POST["enddate4"];}
...
$strXML = "<graph caption='Activated PC ".$_POST["PC"]."' subCaption='' showgridbg='1' lineThickness='1' animation='1' showNames='1' showValues='0' yaxisminvalue='0' numVDivLines='40' formatNumberScale='0' rotateNames='1' areaAlpha='90' showLimits='1' decimalPrecision='1' showAlternateHGridColor='0' divLineDecimalPrecision='0' limitsDecimalPrecision='0' showAreaBorder='0' yAxisName='kbps' xAxisName=' ' >";
$cat = "<categories>";
