...
$strXML = "<graph caption='Actividad MAC ".$_POST["MAC"]."' subCaption='' showgridbg='1' lineThickness='1' animation='1' showNames='1' showValues='0' yaxisminvalue='0' numVDivLines='40' formatNumberScale='0' rotateNames='1' areaAlpha='90' showLimits='1' decimalPrecision='1' showAlternateHGridColor='0' divLineDecimalPrecision='0' limitsDecimalPrecision='0' showAreaBorder='0' yAxisName='kbps' xAxisName=' ' >";
$cat = "<categories>";
$data1 = "<dataset seriesname='Descarga' color='00C080' areaBorderColor='000000'>";
$data2 = "<dataset seriesname='Subida' color='0080C0' areaBorderColor='000000'>";
