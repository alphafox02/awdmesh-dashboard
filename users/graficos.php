...
if(mysql_num_rows($result)==0) die("There are no records that match your selection. <a href=\"../users/users.php\">Back</a>");
...
?>
        ...
        chart.draw(data, {width: 600, height: 100, title: '', textStyle: {color: '#ffffff', fontName: 'Arial', fontSize: 1}, pointSize: '0',lineWidth: '1',colors:['#0084ff','#2f8319'], legend: 'bottom',

                          hAxis: {title: '', showTextEvery:'10', direction:'1', textStyle: {color: '#ffffff', fontName: 'Arial', fontSize: 1}}
