...
if ($_POST['xls'] == 'Export xls') {
	header("Location: list_export.php?tipo=NODE&value=".$_POST['NODE']."&startdate2=".$_POST['startdate2']."&enddate2=".$_POST['enddate2']);
	exit();
}
...
if ($_POST["startdate2"] && (strlen($_POST["startdate2"]) < 12)) {$startdate = rtrim($_POST["startdate2"])." 00:00:00";} else {$startdate = $_POST["startdate2"];}
if ($_POST["enddate2"] && (strlen($_POST["enddate2"]) < 12)) {$enddate = rtrim($_POST["enddate2"])." 23:59:59";} else {$enddate = $_POST["enddate2"];}
...
if(mysql_num_rows($result)==0) die("<div class=error>There are no records that match your selection. <a href=\"../users/users.php\">Back</div>");
...
//-----
$node_fields = array("Node" => "nodeid","Node" => "name","PC" => "c_name","MAC" => "c_mac","Checkin" => "c_time",
...
echo "</tr></tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td align='right'><b>Download &nbsp; <a href='".$protocol."://".$_SERVER['SERVER_NAME']."/". $_SESSION['dashboard'] ."/users/list_export.php?type=NODE&val=".$_POST['NODE']."&startdate=".$_POST['startdate']."&enddate=".$_POST['enddate']."' target='_blank'><img src='../lib/images/excel.ico' width='15' height='15' border='0'></a></td>";
