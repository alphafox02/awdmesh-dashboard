...
<html lang="en">
    <head>
        <title>Create Master Network</title>
...
?>
        ...
        <div id="rail_top">
            <p>
                <a href="login.php" style="color:#8AD355"><strong>Return to login page</strong></a> </p>
</div>
                	...
                	<form method="POST" action="c_create.php"  name="createNetwork">
                      ...
                      <!--  <p><img src="img/awdauthpagelogo.jpg" width="256" height="95"></p> -->
                        <table width="500" border="0">
                          <tr>
                            <td height="66"><div align="center" class="style7">Create Master Network</div></td>
                          </tr>
                          <tr>
                            <td><div align="left" class="style8">Note: If you have already created your master network, don't repeat this step. Simply login and use the network dropdown box to create a new network associated with your existing master network.</div></td>
                          </tr>
                        </table>
                        <br><?php 
            if ($_msg == "E1") {
