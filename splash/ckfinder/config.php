 ...
 * @return boolean
 */
session_start();  //Añadido por Valentin
function CheckAuthentication()
{
	...
	// To be able to use session variables don't forget to add session_start().
	 ...
	 return true;  //Modificado por Valentin
    //return isset($_SESSION['IsAuthorized']);
}

// LicenseKey : Paste your license key here. If left blank, CKFinder will be
// fully functional, in demo mode.
$config['LicenseName'] = 'dashboard.awdmesh.com';
$config['LicenseKey'] = '76H2-PV3F-RFVT-FMTE-PUV3-MJRC-FVRB';
...
*/
//$baseUrl = '/meshcontroller/users_splash/userfiles/';   //Modificado por Valentin
$baseUrl = $_SESSION["UserPath"];
