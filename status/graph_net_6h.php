...
?>
	...
	if(document.getElementById('chart_div')){
		...
		chart.draw(data, {width: 1000, height: 200, title: 'Usage: 6 Hours | <?php echo " Download: ".round($down/1024,2)."GB | Upload: ".round($up/1024,2)."GB | Clients: ".$macrow[0];?>', textStyle: {color: '#000000', fontName: 'Arial', fontSize: 1}, pointSize: '0',lineWidth: '1',colors:['#0084ff','#2f8319','#f3b006'], legend: 'bottom',
...
if($currentTime < strtotime($row["c_time"])+21600) {
